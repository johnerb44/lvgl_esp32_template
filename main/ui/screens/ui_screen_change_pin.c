...
void ui_screen_change_pin_create(void)
{
    ...
    ESP_LOGI(SCREEN_TAG, "Screen object created: %p", (void*)ui_screen_change_pin);
    ...
    lv_obj_add_event_cb(ui_screen_change_pin, screen_loaded_event_cb, LV_EVENT_SCREEN_LOADED, NULL);

    lv_obj_t * change_pin_title = lv_label_create(ui_screen_change_pin);
    lv_label_set_text(change_pin_title, "Change PIN");
