...
/******************************* Example code **************************************/
// Demo chart code removed - this file now only contains hardware port layer
// For UI examples, see main.c template or LVGL documentation at https://docs.lvgl.io/9.3/examples.html

void example_lvgl_demo_ui()
{
    // Demo removed - see main.c for minimal template
}
